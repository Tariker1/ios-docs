...
Luciq App Performance Monitoring automatically captures your HTTP/S network requests when you're using the shared session. If some of your requests don't appear, you can follow the instructions below, depending on your setup: [Custom Session Configuration](setup-network.md#custom-session-configuration), [AFNetworking](setup-network.md#using-afnetworking), or [Alamofire](setup-network.md#using-alamofire).
...
{% include "../../.gitbook/includes/ios-code.md" %}

{% hint style="info" %}
<mark style="color:blue;">Multiple NSURLSessions</mark>
...
{% hint style="warning" %}
<mark style="color:orange;">**iOS minimum version**</mark>
...
_Below is sample code for the interceptor factory:_
