...
If you're already using Luciq, but Session Replay isn't included in your current plan, please reach out to us at [contactus@luciq.ai](mailto:contactus@luciq.ai) We would love to enable a custom trial for you and help you set it up.
...
Enable auto-masking with different levels like masking all text, masking images, or masking everything. You can find more details about auto-masking [here](../custom-settings/privacy-settings/repro-steps.md).

#### Private Views

Set certain screens as private and any private view will automatically appear with a black overlay covering it in any screenshot. You can find more details about private views [here](../custom-settings/privacy-settings/private-views.md).

#### Network Logs Masking

To obfuscate parts of a network request prior to sending it to the dashboard, you can follow the below steps found [here](../custom-settings/privacy-settings/network-masking.md).
