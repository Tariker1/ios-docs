...
{% hint style="warning" %}
To enable SCIM in your company, you must enable [SAML](../../organization-settings/user-management/configure-saml-sso.md) first
{% endhint %}
...
Follow the procedures [here](../../organization-settings/user-management/configure-scim-using-saml/advanced-scim-provisioning.md) to enable role and application access mapping.
{% endhint %}
