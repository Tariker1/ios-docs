...
* luciq//crashes - _contains an extra slash in the middle_
* /luciq/crashes - _contains an extra slash before luciq_
* com/luciq/crashes/list/singleCrash/ - _contains an extra slash after singleCrash_
* luciq/crashes/list/singleCrash/Occurrence - _contains an extra sub-path_
* luciq/cr/list - _Luciq does not match partial words (cr and crashes in this case)_
* crashes/luciq - _path is written in a wrong order_
...
* com..luciq.crashes - _contains an extra dot in the middle_
* .com.luciq.crashes - _contains an extra dot before com_
* com.luciq.crashes.list.singleCrash. - _contains an extra dot after singleCrash_
* crashes.list.singleCrash.Occurrence - _actual path does not contain 'Occurrence'_
* luciq.cr.list - _Luciq does not match partial words (cr and crashes in this case)_
...
As you can see below, you can prioritize the bugs related to your team only and get more granular with the options to filter. For example, Payment team wants to focus on _bugs status' new or in-progress_. Also, you will be able to save those filters and you can access them from the right side of the filter bar.
...
As you can see below, you can prioritize the crashes related to your team only and get more granular with the options to filter. For example, Payment Team wants to focus on _crashes seen in a certain app version_. Also, you will be able to save those filters and you can access them from the right side of the filter bar.
...
**For more details on the different use cases of Alerting, please refer to** [**Alerts & Rules**](../../product-guides/automation-and-workflows/alerts-and-rules/) **product guides.**
...
**For more details on the different integrations that is supported, please refer to** [**Luciq's Integrations Docs**](../../product-guides/integrations/)
